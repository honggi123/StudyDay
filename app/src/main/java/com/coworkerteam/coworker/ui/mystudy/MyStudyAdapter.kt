...
class MyStudyAdapter(private val context: Context) : RecyclerView.Adapter<MyStudyAdapter.ViewHolder>(){

    var datas = mutableListOf<MyStudyResponse.Result.Group>()
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        layoutParams.width = (ScreenSizeUtils().getScreenWidthSize(context as Activity)/2).toInt()
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(item:MyStudyResponse.Result.Group) {
